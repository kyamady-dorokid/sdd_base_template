...
MANAGED_BLOCKS=(
  ...
  ".claude/skills/kiro-spec-requirements/rules/ears-format.md|SDD-OVERLAY:EARS-PLAIN-JA|patch|fix-ears-plain-japanese.sh"
  ".agents/skills/kiro-spec-requirements/rules/ears-format.md|SDD-OVERLAY:EARS-PLAIN-JA|patch|fix-ears-plain-japanese.sh"
  ".claude/skills/kiro-spec-requirements/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-spec-requirements/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-spec-design/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-spec-design/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-spec-tasks/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-spec-tasks/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-spec-init/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-spec-init/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-validate-design/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-validate-design/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-validate-gap/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-validate-gap/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-validate-impl/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-validate-impl/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-discovery/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-discovery/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-steering/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-steering/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-steering-custom/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-steering-custom/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".claude/skills/kiro-impl/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
  ".agents/skills/kiro-impl/SKILL.md|SDD-OVERLAY:PLAIN-JAPANESE-OUTPUT|patch|fix-plain-japanese-output.sh"
)
